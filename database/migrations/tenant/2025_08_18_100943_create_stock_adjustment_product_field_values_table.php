...
return new class extends Migration {
    ...
    {
        Schema::connection('tenant')->create('stock_adjustment_product_field_values', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::connection('tenant')->dropIfExists('stock_adjustment_product_field_values');
    }
};
