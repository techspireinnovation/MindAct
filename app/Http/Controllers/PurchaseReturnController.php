    ...
    public function store(Request $request): JsonResponse
    {
        try {
            $validator = Validator::make($request->all(), [
                ...
                'discount_amount_vat' => 'nullable|numeric|min:0',
                ...
                'purchase_return_products.*.quantity' => 'required|integer|min:0',
                'purchase_return_products.*.free_quantity' => 'nullable|integer|min:0',
    ...
    public function update(Request $request, $id): JsonResponse
    {
        try {
            $validator = Validator::make($request->all(), [
                ...
                'purchase_return_products.*.expiry_date' => 'nullable|date',
                'purchase_return_products.*.field_values' => 'nullable|array',
                'purchase_return_products.*.field_values.*' => 'arra',
                'purchase_return_products.*.field_values.*.*.id' => [
                    ...
                    Rule::exists('purchase_return_product_field_values', 'id')->where(function ($query) use ($request) {
                        $index = explode('.', $request->getRuleKey())[2];
