...
return new class extends Migration {
    ...
    {
        Schema::connection('tenant')->create('stock_reconciliated_field_values', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::connection('tenant')->dropIfExists('stock_reconciliated_field_values');
    }
};
