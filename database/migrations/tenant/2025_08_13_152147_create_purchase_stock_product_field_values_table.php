...
return new class extends Migration {
    ...
    {
        Schema::connection('tenant')->create('purchase_stock_product_field_values', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::connection('tenant')->dropIfExists('purchase_stock_product_field_values');
    }
};
