...
class StockAdjustedFieldValue extends BaseTenantModel
{
    ...
    public function stockAdjustedProduct()
    {
        return $this->belongsTo(StockAdjusted::class, 'purchase_stock_product_id');
    }
