...
use App\Http\Requests\StockSalesReturnRequest\StoreRequest;
use App\Http\Requests\StockSalesReturnRequest\UpdateRequest;

use Illuminate\Http\Request;

class StockSalesReturnController extends Controller
{
    protected $repository;

    public function __construct(StockSalesReturnRepositoryInterface $repository)
    {
    ...
    public function index(Request $request)
    {
        try {
            ...
            return response()->json(['message' => 'An error occurred while listing the stock sales return', 'error' => $e->getMessage()], 500);
        }
    }
