        ...
        try {
            ...
            if (Cache::has($cacheKey)) {
                ...
                $rows = $items->cursor()->map(function ($item) use (&$sn) {
                    ...
                    $cogs = $item->opening_rate * $item->opening_quantity + $purchase_detail['avg_price'] * $purchase_detail['qty'] + $sale_return_detail['avg_price'] * $sale_return_detail['qty'] - $purchase_return_detail['avg_price'] * $purchase_return_detail['qty'];
                    -$closingAmount;
