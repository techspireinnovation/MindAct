...
class StoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'party_id' => 'nullable|inetger',
            'location_id' => 'nullable|inetger',
            ...
            'stock_transactions.*.party_id' => 'nullable|string',
            ...
            'stock_transactions.*.quantity' => 'required|numeric',
            ...
            'stock_transactions.*.field_values.*.*.key' => 'required|string',
            'stock_transactions.*.field_values.*.*.value' => 'required|string|max:255',
