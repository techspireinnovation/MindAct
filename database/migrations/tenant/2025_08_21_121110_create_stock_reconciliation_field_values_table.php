...
return new class extends Migration {
    ...
    {
        Schema::connection('tenant')->create('stock_reconciliation_field_values', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('stock_reconciliation_id')->nullable();
            $table->unsignedBigInteger('stock_reconciliation_detail_id')->nullable();
    ...
    {
        Schema::connection('tenant')->dropIfExists('stock_reconciliation_field_values');
    }
};
